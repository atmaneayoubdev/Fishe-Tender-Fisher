...
class EditProductView extends StatefulWidget {
  const EditProductView({Key? key, required this.id}) : super(key: key);
  static final String routeName = '/edit_product_view';
  final int id;
      ...
      await ProductsControlller.getFisherProductDetails(
        ...
        if (mounted)
          setState(() {
            ...
            selectedImage = _fisherProductsDetails!.images.first;
            _selectedProduct = Product(
              name: _fisherProductsDetails!.product.name,
              categoryId: _fisherProductsDetails!.product.categoryId.toString(),
              description: _fisherProductsDetails!.product.description,
              id: _fisherProductsDetails!.product.id,
            );
          });
      });
      fetchAllUnits();
      fetchAllServices().then((value) {
        if (mounted)
          setState(() {
            _fisherProductsDetails!.units.forEach((element) {
              _finalSelectedUnits.add(
                AddUnit(id: element.id, price: element.price),
              );
              _selectedUnits.add(
                Unit(id: element.id, name: element.name, note: element.note),
              );
              height = height + 20;
            });

            _fisherProductsDetails!.services.forEach((element) {
              _finalSelectedServices.add(
                AddService(id: element.id, price: element.price),
              );
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.symmetric(horizontal: 18.w),
                              child: TitleWidget(
                                title: LocaleKeys.market_account_fish_category
                                    .tr(),
                                color: kprimaryColor,
                              ),
                            ),
                            ...
                            Container(
                              ...
                              child: DropdownButton<Categorie>(
                                hint: Text(_fisherProductsDetails!
                            ...
                            Container(
                              ...
                              child: DropdownButton<Product>(
                                hint:
                                    Text(_fisherProductsDetails!.product.name),
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  TitleWidget(
                                    title: LocaleKeys.market_account_fish_units
                                        .tr(),
                                    color: kprimaryColor,
                                  ),
                                  SizedBox(
                            ...
                            GestureDetector(
                              onTap: () async {
                                ...
                                /*if (_finalSelectedServices.isEmpty) {
                                  if (mounted)
                                    setState(() {
                                ...
                                if (_fisherProductsDetails != null)
                                  await ProductsControlller.updateFisherProduct(
                                    token: Provider.of<UserProvider>(
                                      context,
                                      listen: false,
                                    ).user.token!,
                                    id: _fisherProductsDetails!.id.toString(),
                                    productId: _selectedProduct != null
                                        ? _selectedProduct!.id.toString()
                                        : _fisherProductsDetails!.productId
                                            .toString(),
                                    ...
                                    fileImages: Provider.of<ImgProvider>(
                                      context,
                                      listen: false,
                                    ).imageFile,
                                  ).then((value) {
