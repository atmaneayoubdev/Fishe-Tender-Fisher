...
class TipsInstructionsView extends StatefulWidget {
  const TipsInstructionsView({Key? key}) : super(key: key);
  static final String routeName = '/tips_instructions';

  @override
  _TipsInstructionsViewState createState() => _TipsInstructionsViewState();
}

class _TipsInstructionsViewState extends State<TipsInstructionsView> {
  @override
      ...
      body: Container(
        child: Column(
          children: [
            ...
            Expanded(
              child: FutureBuilder(
                future: HelpSupportController.getInstructons(
